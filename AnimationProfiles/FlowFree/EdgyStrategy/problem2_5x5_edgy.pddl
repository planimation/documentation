; Title: FlowFree Problem2-5x5 (Edgy Strategy)
; Author: Aditi Basu
...
(define (problem FlowFree-5x5)
    ...
    (:init
        ...
        (pipe node1-5)
        (pipe node3-4)
        (pipe node2-2) (pipe node4-2)
        (pipe node4-1)
        (pipe node3-5) (pipe node5-5)
        (pipe node5-4)
        (pipe node2-1) (pipe node3-1)
    ...
    (:goal (and
        ...
        ; pipe relations
        (pipe node2-5) (pipe node4-5)
        (pipe node1-4) (pipe node2-4) (pipe node4-4)
        (pipe node1-3) (pipe node2-3) (pipe node3-3) (pipe node4-3) (pipe node5-3)
        (pipe node1-2) (pipe node3-2) (pipe node5-2)
        (pipe node1-1) (pipe node5-1)
        )
    )
