(define (problem prob_4plus5_with_5_clear)
    (:domain soldier_move)
    
    (:objects 
        ground1 ground2 ground3 ground4 ground5 ground6 ground7 ground8 ground9 ground10
        leftPerson1 leftPerson2 leftPerson3 leftPerson4 rightPerson1 rightPerson2 rightPerson3 rightPerson4 rightPerson5
    )
    ...
    (:init
        ...
        (onGround rightPerson5 ground10)
    )
    ...
    (:goal 
        (and
            ...
            (onGround leftPerson3 ground9)
            (onGround leftPerson4 ground10)
