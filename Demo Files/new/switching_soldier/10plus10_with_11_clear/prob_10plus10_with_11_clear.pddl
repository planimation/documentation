(define (problem prob_4plus4_with_5_clear)
    ...
    (:objects 
        ground1 ground2 ground3 ground4 ground5 ground6 ground7 ground8 ground9 ground10 ground11
        ground12 ground13 ground14 ground15 ground16 ground17 ground18 ground19 ground20 ground21
        leftPerson1 leftPerson2 leftPerson3 leftPerson4 leftPerson5
        leftPerson6 leftPerson7 leftPerson8 leftPerson9 leftPerson10
    ...
    (:init
        ...
        (nextGround ground20 ground21)
        
        (groundClear ground11)
        ...
        (onGround leftPerson10 ground10)
        
        (onGround rightPerson1 ground12)
        (onGround rightPerson2 ground13)
        (onGround rightPerson3 ground14)
        (onGround rightPerson4 ground15)
        (onGround rightPerson5 ground16)
        (onGround rightPerson6 ground17)
        (onGround rightPerson7 ground18)
        (onGround rightPerson8 ground19)
        (onGround rightPerson9 ground20)
        (onGround rightPerson10 ground21)
    )
    ...
    (:goal
        (and
            ...
            (onGround leftPerson10 ground21)
